	...
	<view class="photo-container">
		...
		<view class="image-section">
			<swiper class="image-swiper" :indicator-dots="true" :autoplay="true" :interval="3000" :duration="500">
				<swiper-item v-for="(image, index) in photoImages" :key="index">
		...
		<view class="service-info">
			<view class="service-header">
				<text class="service-title">满月照</text>
				<text class="service-price">¥99</text>
			</view>
			<view class="service-description">
				<text class="description-text">专业满月照拍摄服务，提供多套服装和道具，由经验丰富的摄影师操作，为宝宝留下美好的满月回忆。</text>
				<view class="service-features">
					<view class="feature-item">
						<text class="feature-icon">📸</text>
						<text class="feature-text">专业摄影师</text>
					</view>
					<view class="feature-item">
						<text class="feature-icon">👗</text>
						<text class="feature-text">多套服装</text>
					</view>
					<view class="feature-item">
						<text class="feature-icon">🎨</text>
						<text class="feature-text">精美道具</text>
					</view>
					<view class="feature-item">
						<text class="feature-icon">💾</text>
						<text class="feature-text">精修照片</text>
					</view>
				</view>
			</view>
		</view>

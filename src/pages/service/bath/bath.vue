	...
	<view class="bath-container">
		...
		<view class="service-info">
			<view class="service-header">
				<text class="service-title">婴儿洗澡</text>
				<text class="service-price">免费</text>
			</view>
			<view class="service-description">
				<text class="description-text">专业婴儿洗澡服务，使用温和无刺激的洗护用品，由经验丰富的护理人员操作，让宝宝享受舒适的洗澡体验。</text>
				<view class="service-features">
					<view class="feature-item">
						<text class="feature-icon">🛁</text>
						<text class="feature-text">专业洗护用品</text>
					</view>
					<view class="feature-item">
						<text class="feature-icon">👩‍⚕️</text>
						<text class="feature-text">经验丰富护理人员</text>
					</view>
					<view class="feature-item">
						<text class="feature-icon">🌡️</text>
						<text class="feature-text">恒温环境</text>
					</view>
					<view class="feature-item">
						<text class="feature-icon">🧼</text>
						<text class="feature-text">无刺激配方</text>
					</view>
				</view>
			</view>
		</view>
